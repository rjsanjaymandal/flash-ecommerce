...
import { uploadOptimizedImage, type OptimizedImages } from '@/app/actions/upload-images'
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className={cn(
        ...
        !preview && "h-64 flex flex-col items-center justify-center cursor-pointer",
        ...
        {isUploading ? (
          ...
          <label className="flex flex-col items-center justify-center w-full h-full cursor-pointer">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center max-w-[200px]">
              We'll automatically generate thumbnail, mobile, and desktop variants.
            </p>
            <input 
              type="file" 
              accept="image/*" 
