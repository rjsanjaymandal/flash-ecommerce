      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-20 items-center px-8 border-b border-slate-800/50">
          <Link href="/admin" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-500">Enterprise</span>
            </div>
          </Link>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-8">
            ...
            <div className="space-y-2">
                <h3 className="px-4 text-xs font-bold text-indigo-400/80 mb-2 uppercase tracking-widest">Overview</h3>
                ...
                {navItems.map((item) => {
                    ...
                    >
                        <item.icon className={cn("h-5 w-5 transition-transform group-hover:scale-110", isActive ? "text-indigo-200" : "text-slate-500 group-hover:text-slate-300")} />
                        {item.label}
                    </Link>
                    )
                })}
            ...
            {/* Secondary Nav */}
            <div className="space-y-2">
                 <h3 className="px-4 text-xs font-bold text-slate-600 mb-2 uppercase tracking-widest">Support</h3>
                 <nav className="space-y-1">
                    {secondaryItems.map((item) => {
                        ...
                        >
                            <item.icon className={cn("h-5 w-5", isActive ? "text-indigo-400" : "text-slate-500 group-hover:text-slate-300")} />
                            {item.label}
                        </Link>
                        )
                    })}
        ...
        <div className="p-4 border-t border-slate-800/50 bg-[#0b1120]">
            ...
            <div className="mt-3 text-center">
                 <Link href="/" target="_blank" className="text-xs text-indigo-400 hover:text-indigo-300 hover:underline flex items-center justify-center gap-1">
