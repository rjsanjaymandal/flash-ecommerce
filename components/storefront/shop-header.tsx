...
export function ShopHeader() {
  return (
    <div className="flex flex-col items-center text-center gap-4 mb-16 max-w-4xl mx-auto py-16 relative w-full overflow-hidden">
      ...
      <motion.h1
        ...
        className="text-4xl md:text-[8.5rem] font-black tracking-tighter text-foreground leading-[0.8] uppercase italic"
      >
        THE{" "}
