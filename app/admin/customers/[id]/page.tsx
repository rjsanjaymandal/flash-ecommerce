...
import { ArrowLeft, Loader2, Trash2, ShoppingCart, Heart } from "lucide-react";
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4 pb-2">
              <Avatar className="h-16 w-16 border-2 border-primary/10">
                <AvatarImage
                  src={`https://avatar.vercel.sh/${profile.email}`}
                />
              ...
              <div>
                ...
                <Badge variant="outline">
                  {profile.fit_preference || "No Fit Pref"}
                </Badge>
              </div>
            </CardHeader>
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <Card className="border-blue-200 bg-blue-50/10 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              {cart.length > 0 && (
                <Button variant="destructive" size="sm" onClick={clearUserCart}>
