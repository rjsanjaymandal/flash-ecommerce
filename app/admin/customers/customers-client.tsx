              ...
              initialCustomers.map((customer) => (
                ...
                >
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div
                          className="text-xs text-muted-foreground w-32 truncate"
                  ...
                  <TableCell>
                    ...
                    <Badge
                      variant={
                        customer.stats.totalOrders > 0 ? "default" : "secondary"
                      }
                      className={cn(
                  ...
                  <TableCell>
                    <span
                      className={cn(
                        "inline-flex items-center px-2 py-1 rounded-md text-xs font-medium",
                        customer.stats.wishlistCount > 0
