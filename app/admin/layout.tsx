  ...
  return (
    <AdminGuard>
      ...
      <div className="flex min-h-screen w-full admin-theme bg-background text-foreground">
        <AdminSidebar />
        <div className="flex flex-col sm:pl-72 w-full transition-all duration-300">
          ...
          <main className="flex-1 p-4 sm:px-8 sm:py-8 md:gap-8 lg:py-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            {children}
          </main>
        </div>
      </div>
